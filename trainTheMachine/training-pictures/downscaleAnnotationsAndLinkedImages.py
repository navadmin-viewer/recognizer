...
# Run this script from the containing directory of ALL image directories and image-directories.txt.
...
IMAGE_DIRECTORY_FILE = 'rename-strip-downscale-image-directories.txt'
...
for imageDir in imageDirs:
	...
	annotationRescaled_filePath = imageDir + '/' + ANNOTATION_FILE
